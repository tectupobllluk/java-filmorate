...
CREATE TABLE events (
    ...
    CONSTRAINT user_id_con FOREIGN KEY (user_id) REFERENCES user (user_id),
--     ON UPDATE RESTRICT
    CONSTRAINT event_type_con FOREIGN KEY (event_type) REFERENCES event_types (type_id),
--     ON DELETE RESTRICT
    CONSTRAINT operation_type_con FOREIGN KEY (operation_type) REFERENCES operation_types(operation_id)
);
